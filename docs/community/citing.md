...
If you write a paper using results obtained with the help of deal.II,
please cite the following two references (or one of the ones listed
below for other versions of deal.II). Specific features of deal.II are
also discussed in a set of publications listed on [a separate
page](publications-details.md).
...
-       D. Arndt, W. Bangerth, B. Blais, M. Fehling, R. Gassm&ouml;ller,
